...
Shader "ANGRYMESH/Nature Pack/Vegetation Studio/Props Snow"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			half3 lerpResult158 = lerp( tex2DNode96 , BlendNormals( UnpackScaleNormal( tex2D( _BaseNormalMap, uv_BaseNormalMap288 ), ( _BumpScale * 0.5 ) ) , UnpackScaleNormal( tex2D( _TopNormalMap, Top_UVScale197 ), _TopNormalIntensity ) ) , ( Top_Mask168 * Top_Noise225 ).rgb);
			...
			half4 lerpResult157 = lerp( ( _BaseColor * tex2DNode162 ) , ( _TopColor * tex2DNode172 ) , ( Top_Mask168 * Top_Noise225 ));
...
/*ASEBEGIN
Version=17402
1927;35;1902;998;4928.525;342.595;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;330;-4352,288;Inherit;False;AG Global Snow - Height;-1;;3;792d553d9b3743f498843a42559debdb;0;0;1;FLOAT;43
Node;AmplifyShaderEditor.FunctionNode;317;-4352,128;Inherit;False;AG Global Snow - Props;-1;;1;13862ff5366d2ea409a2b82c7b7675e1;0;4;22;FLOAT;0;False;24;FLOAT;0;False;23;FLOAT;0;False;25;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;329;-3968,128;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=2428DDDE0F020CC19E1E77A23AEA6AE6E23E6A7E